...
\begin{figure}[htbp]
  \begin{center}
     \fbox{\includegraphics[width=100mm]{images/room_panorama.jpg}}
  \end{center}
...
\begin{figure}[htbp]
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \fbox{\includegraphics[width=60mm]{images/test_calendar.png}}
    \end{center}
    \caption{仮想的に代替したカレンダー}
  \end{minipage}
  \begin{minipage}{0.5\hsize}
    \begin{center}
      \fbox{\includegraphics[width=60mm]{images/test_digital_clock.png}}
    \end{center}
